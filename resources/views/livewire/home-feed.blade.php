{{-- <div> --}}
    ...
    @foreach ($posts as $post)
            ...
            @endforeach
            <button wire:click="loadMore" class="m-5 m-auto mt-3 flex gap-2 text-xs items-center rounded-full px-16 py-2 font-semibold bg-gray-800 hover:bg-black text-white"> Show More</button>
        </section>
{{-- </div> --}}
